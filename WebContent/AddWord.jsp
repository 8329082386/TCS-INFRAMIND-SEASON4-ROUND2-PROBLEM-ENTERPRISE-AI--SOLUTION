...
<div class="container">
<form>
				<input type="text" name="word" placeholder="Enter word" required class="form-control" >
				...
				if(str22!=null){
					...
					try{
						...
						PreparedStatement prstm=conn.prepareStatement("insert into words (word,category)values(?,?);");
