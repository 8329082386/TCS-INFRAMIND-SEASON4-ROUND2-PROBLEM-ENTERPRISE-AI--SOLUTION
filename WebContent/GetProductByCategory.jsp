...
%>
	...
	%>
		<h4>Search :<%out.println(cat); %>  </h4>
	<hr>
			  <ul class="thumbnails">
			  
			    <%
			    
			    PreparedStatement stm34=conn.prepareStatement("select * from product pd,images img where pd.uid=img.pid and pd.category=?");
			    stm34.setString(1, cat);
			    ResultSet rs34=stm34.executeQuery();
			    while(rs34.next()){
			   %>
			  
				<li class="span3">
				  <div class="thumbnail">
					<a  href="GetProductDetails.jsp?pid=<%out.println(rs34.getString(1));%>"><img src="images/<%out.println(rs34.getString(8)); %>" alt=""/></a>
					<div class="caption">
