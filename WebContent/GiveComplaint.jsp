...
%>
			...
			<div class="span6">
				...
				<br/>
				<textarea name="complaint" rows="" cols="" class="form-control" placeholder="Have you any complaint about product"></textarea>
				<br/>
				...
				if(str22!=null){
					...
					try{
						Class.forName("com.mysql.jdbc.Driver");
						conn = DriverManager.getConnection("jdbc:mysql://localhost/ecommerce", "root","root");
						PreparedStatement prstm=conn.prepareStatement("insert into complaints (pid,complaint)values(?,?);");
					    prstm.setString(1, request.getParameter("pid"));
					    prstm.setString(2, request.getParameter("complaint").trim());
						prstm.executeUpdate();
						
					%>
					<script>
					
					alert("Thanks For your valuable complaint")
					</script>
