			...
			<div class="span6">
				...
				if(str22!=null){
					...
					try{
						Class.forName("com.mysql.jdbc.Driver");
						conn = DriverManager.getConnection("jdbc:mysql://localhost/ecommerce", "root","root");
						PreparedStatement prstm=conn.prepareStatement("insert into reviews (pid,review)values(?,?);");
					    prstm.setString(1, request.getParameter("pid").trim());
					    prstm.setString(2, request.getParameter("review").trim());
						prstm.executeUpdate();
